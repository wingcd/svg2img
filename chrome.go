...
var (
	...
	DefaultChromPaths = []string{
		...
		"C:/Users/wing/AppData/Local/Google/Chrome/Application/chrome.exe",
	}
...
func NewChrome() *Chrome {
	...
	version := "89" //getChromeVersion(path)
...
func (chrome Chrome) Screenshoot(websiteURL string, destination string, background string) error {
	...
	args := []string{
		...
		"--hide-scrollbars",
		fmt.Sprintf("--default-background-color=%v", background),
		"--disable-gpu",
